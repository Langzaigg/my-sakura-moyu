...
!insertmacro MUI_PAGE_LICENSE "HSVER.txt"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${Section1} "游戏文本和对话的翻译（個人漢化）"
  !insertmacro MUI_DESCRIPTION_TEXT ${Section2} "图形文本翻译，包括界面、菜单、立绘名字和部分CG（by MY）"
  !insertmacro MUI_DESCRIPTION_TEXT ${Section3All} "给开幕视频和末尾插入歌嵌入ASS字幕（by MY）"
